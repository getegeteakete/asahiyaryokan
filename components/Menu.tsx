  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto">
        ...
        <p className="text-[14px] text-kinari/70 mb-16 md:mb-20 font-light max-w-[600px]">{t('intro')}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 lg:items-center mb-20 md:mb-28">
          ...
          <div>
            ...
            <p className="text-[14px] leading-[2] text-kinari/70 mb-6 font-light">{t('kaisendon.desc')}</p>
            <div className="p-5 bg-kinari/5 border border-kinari/10 mb-5">
              <div className="flex justify-between items-baseline">
                <span className="text-[15px] tracking-[0.08em] font-light">{t('kaisendon.bowlOnly')}</span>
                <div className="text-right">
                  <div className="font-cormorant text-[18px] text-kin-light">¥{t('kaisendon.bowlOnlyPrice')}</div>
                  <span className="text-[10px] text-clay tracking-[0.1em] font-light">{t('taxIncl')} ¥{t('kaisendon.bowlOnlyPriceIncl')}</span>
                </div>
              </div>
            </div>
            <p className="text-[11px] text-kinari/50 tracking-[0.1em] leading-[1.9] font-light">{t('kaisendon.note')}</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 lg:items-center mb-20 md:mb-28">
          ...
          <div className="lg:order-1">
            ...
            <p className="text-[14px] leading-[2] text-kinari/70 mb-6 font-light">{t('asahizen.desc')}</p>
            <p className="text-[11px] text-kinari/50 tracking-[0.1em] leading-[1.9] font-light">{t('asahizen.note')}</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="mb-5 p-5 bg-kinari/5 border border-kinari/10">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="text-[13px] tracking-[0.05em] font-light"><span className="text-kin-light mr-2">・</span>{t('kamameshi.ing1')}</div>
                <div className="text-[13px] tracking-[0.05em] font-light"><span className="text-kin-light mr-2">・</span>{t('kamameshi.ing2')}</div>
                <div className="text-[13px] tracking-[0.05em] font-light"><span className="text-kin-light mr-2">・</span>{t('kamameshi.ing3')}</div>
                <div className="text-[13px] tracking-[0.05em] font-light"><span className="text-kin-light mr-2">・</span>{t('kamameshi.ing4')}</div>
              </div>
            </div>
            ...
            <div className="mb-5 p-5 bg-kinari/5 border border-kinari/10">
              <div className="flex justify-between items-baseline">
                ...
                <div className="text-right">
                  <div className="font-cormorant text-[16px] text-kin-light">¥{t('kamameshi.potOnlyPrice')}</div>
                  <span className="text-[10px] text-clay tracking-[0.1em] font-light">{t('taxIncl')} ¥{t('kamameshi.potOnlyPriceIncl')}</span>
                </div>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-kinari/20">
          <div className="flex items-baseline gap-4 mb-8">
            <h3 className="text-[26px] font-medium tracking-[0.08em]">{t('tabs.teishoku')}</h3>
            <span className={`text-[12px] tracking-[0.2em] text-kin-light font-light ${isJa ? 'font-cormorant italic' : 'font-mincho not-italic'}`}>
              Set Meals
            </span>
          </div>
            ...
            {Object.entries(t.raw('teishoku')).map(([key, value]: any) => {
              ...
              return (
                <div key={key} className="flex justify-between items-baseline gap-4 py-4 px-6 bg-kinari/5 border border-kinari/10 hover:border-kinari/30 transition-colors">
                  <span className="text-[15px] tracking-[0.08em] font-light flex-1">{value.name}</span>
                  <div className="text-right flex-shrink-0">
                    <div className="font-cormorant text-[16px] text-kin-light">¥{value.price}</div>
                    <span className="text-[10px] text-clay tracking-[0.1em] font-light">{t('taxIncl')} ¥{value.priceIncl}</span>
                  </div>
                </div>
              );
            })}
